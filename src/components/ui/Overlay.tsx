      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-[#1A1A1A] border-0 md:border border-white/10 rounded-none md:rounded-xl w-full md:max-w-lg h-full md:h-auto md:max-h-[90vh] shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}
